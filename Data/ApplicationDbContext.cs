...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<CustomerTotalSpending> CustomerTotalSpendings { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2769B60180");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B456217ACF");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85115F7AED");
        ...
        modelBuilder.Entity<CustomerTotalSpending>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("CustomerTotalSpending");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DailyTra__3213E83F9FB1B18B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LastTran__3213E83F86D9F11F");

            entity.ToTable("LastTransaction");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229DA64EBEA");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C60885BD");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF56C989870");

            entity.ToTable("products", "production");

            entity.HasIndex(e => e.ModelYear, "ix_model_year");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C758B2344");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616420778175").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D36BF6544C");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C1B6A70E5");
